...
use App\Infrastructure\Services\Legacy\AtomApiDb as AtomAPIDB;
...
//    public $time_update = 60 * 24; //  Час оновлення (буферизації) (ХВИЛИНИ)
    ...
    private function run($inside_request = 'no')
    {
...
// Функція запису довідника в базу ///////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    public function getStatusesPlatforms()
    {
        ...
        $res = AtomAPIDB::query("SELECT * FROM serviceapi_attika_platforms_statuses");
