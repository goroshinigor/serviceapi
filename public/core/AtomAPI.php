...
class AtomAPI
{
    ...
    public function gogo()
    {
        ...
        if ($b['id'] > 0) {
            ...
            $this->status = false;
            $this->msg['code'] = 60004; // Пользователь не обнаружен в Базе
        }
        ...
        if ($this->status) {
            ...
            $obj['client_update'] = "ServiceAPIClientsUpdate";
            $obj['client_delete'] = "ServiceAPIClientsDelete";
            $obj['client_info'] = "ServiceAPIClientsInfo";
            $obj['client_verify_phone'] = "ServiceAPIClientsVerifyPhone";
            $obj['client_check_phone'] = "ServiceAPIClientsCheckPhone";
            $obj['client_login_phone'] = "ServiceAPIClientsLoginPhone";
            $obj['sms_send'] = "ServiceAPIServicesSMSSend";
            $obj['calc_ew_price'] = "ServiceAPICalculateEWPrice";
            $obj['filials_list'] = "ServiceAPIFilialsList";
            $obj['branches_locator'] = "ServiceAPIGeocoding";
            $obj['get_ew_info'] = "ServiceAPIEWInfo";
            $obj['get_ew_all_info'] = "ServiceAPIEWInfoAll";
            $obj['get_statuses_list'] = "ServiceAPIStatusesList";
            $obj['tracking'] = "ServiceAPITracking";
            ...
            if (!$class and !class_exists($class)) $class = 'AtomAPI404'; // если нет такого то объявляем класс 404
